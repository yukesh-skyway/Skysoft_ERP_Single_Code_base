...
function MonthViewInner({
  ...
  const handleShiftClick = (shift: Block, category: Resource): void => {
  ...
  return (
    <div
      ref={ref}
      style={{ display: "flex", flexDirection: "row", flex: 1, overflow: "hidden", userSelect: "none" }}
      onPointerMove={onPM}
      onPointerUp={onPU}
              ...
              {dayShifts.slice(0, 3).map((shift) => {
                ...
                return (
                  <div
                    ...
                    onDoubleClick={(e) => {
                      e.stopPropagation()
                      handleShiftClick(shift, category)
                    }}
                    style={{
